...
function log(obj) {
    ...
    document.getElementById("myemail").setAttribute("value","Email sent!");
    document.getElementById("myemail").setAttribute("onclick","");
}
...
function sendTheMail() {
    ...
    params["message"]["to"][0]["email"] = menteeEmail;
